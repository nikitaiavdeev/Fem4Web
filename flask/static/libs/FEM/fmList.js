...
fmList.prototype = {
	fromArr:function(isNode = true){
		let start = '', step, step1, 
			arr, list = '';
		...
		try { step1 = arr[1].id - arr[0].id;}
		catch{ step1 = null;}
		for(let i = 0; i < arr.length; i++){
			step = step1;
			try { step1 = arr[i+2].id - arr[i+1].id; }
			catch { step1 = null; }
	...
	listToArray:function(list, isNode = true){
